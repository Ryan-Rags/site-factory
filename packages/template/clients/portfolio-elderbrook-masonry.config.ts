 ...
 *
 * Elderbrook Masonry does not exist. Nothing in this file describes a real company, a
 * real person or real work, and the build it produces is linked publicly from
 * raghubans.com/sites as one of five showcases of the heritage family.
 *
...
const base: SiteConfig = {
  business: {
    name: 'Elderbrook Masonry',
    legalName: 'Elderbrook Masonry (demonstration site)',
    tagline: 'Stone, brick and hardscape, built the way it was built before.',
    phone: '(555) 010-0132',
    phoneHref: '+15550100132',
    smsHref: '+15550100132',
    email: 'hello@example.invalid',
    address: {
      street: '9 Kilnwright Lane',
      locality: 'Elderbrook',
      region: 'NJ',
      postalCode: '07473',
      country: 'US',
    },
    serviceArea: ["Elderbrook","Stonemarch","Wexley","Bramblewick"],
  ...
  brand: {
    ...
    favicon: '/favicon.svg',
    ogImage: '/og/portfolio-elderbrook-masonry.png',
  },

  hero: {
    headline: 'Work that outlasts the person who ordered it.',
    subhead:
      'Repointing, stone walls, chimneys, patios and steps for houses around Elderbrook — matched to what is already there.',
  ...
  trustStrip: [
      {
          "icon": "shield",
          "label": "Mortar matched to the wall"
      },
      {
          "icon": "wrench",
          "label": "Hand-cut stone"
      },
      {
          "icon": "badge",
  ...
  services: [
    {
      slug: 'repointing-restoration',
      title: 'Repointing & restoration',
      oneLiner: 'Old mortar cut out and replaced with a mix that suits the wall it is going into.',
      icon: 'shield',
    ...
    {
      slug: 'stonework',
      title: 'Stone walls & steps',
      oneLiner: 'Dry-laid and mortared walls, steps and pillars, cut on site to fit.',
      icon: 'wrench',
      image: '/images/service-custom-fabrication.svg',
      imageAlt: 'Placeholder illustration on a demonstration build',
    },
    {
      slug: 'patios-hardscape',
      title: 'Patios & hardscape',
      oneLiner: 'Patios, walkways and driveways built on a base that will not move.',
      icon: 'badge',
  ...
  about: {
    headline: 'A trade that has not changed much, done properly.',
    entry: 'about',
  ...
  testimonials: [
    {
      quote:
        'They cut out the previous contractor’s pointing and explained exactly why it had failed. The wall has been dry since.',
    ...
    {
      quote:
        'The steps look like they came with the house, which is what we asked for.',
      attribution: 'Homeowner',
      role: 'Wexley',
      rating: 5,
      sourceNote: 'Invented for a demonstration build. Nobody said this.',
    ...
    {
      quote:
        'They spent a full day on the base before laying anything. Four winters on, nothing has shifted.',
      attribution: 'Homeowner',
      role: 'Stonemarch',
      rating: 5,
      sourceNote: 'Invented for a demonstration build. Nobody said this.',
  ...
  cta: {
    ...
    body: 'This is a demonstration build. Elderbrook Masonry is an invented business created to show a design family — no such company exists, and nothing here describes anybody’s real work.',
  ...
  pages: {
    home: {
       ...
       */
      title: 'Masonry, stonework & hardscape',
    ...
    services: {
      ...
      metaDescription:
        'Demonstration build for an invented business. Masonry & hardscape services, shown to illustrate a design family.',
    },
    about: {
      eyebrow: 'Elderbrook · Elderbrook, NJ',
      metaDescription:
  ...
  seo: {
    titleTemplate: '%s | Elderbrook Masonry',
    defaultDescription:
      'Stone, brick and hardscape, built the way it was built before. A demonstration build for an invented business.',
    siteUrl: 'https://portfolio-elderbrook-masonry.pages.dev',
    noindex: true,
  },
...
export const site: SiteConfig = { ...base, design: designFor('portfolio-elderbrook-masonry', base) };
