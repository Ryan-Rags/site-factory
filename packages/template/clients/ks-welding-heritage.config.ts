/**
 * K&S WELDING & FABRICATING — Heritage family.
 *
...
export const site: SiteConfig = {
  ...
  brand: { ...ksWelding.brand, ogImage: '/og/ks-welding-heritage.png' },
  design: inFamily(
    ksWeldingDesign,
    { preset: 'heritage', accent: 'brick', fontPairing: 'old-serif' },
    // Heritage wants the raised panel — a serif headline on cream, framed,
    // over a warm field. A shopfront sign, essentially.
    'stacked-panel',
  ),
};
